...
ActiveRecord::Schema[7.1].define(version: 2026_02_23_140000) do
  ...
  create_table "jwt_revocations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["jti"], name: "index_jwt_revocations_on_jti", unique: true
    t.index ["user_id"], name: "index_jwt_revocations_on_user_id"
  end
  ...
  add_foreign_key "jwt_revocations", "users"
